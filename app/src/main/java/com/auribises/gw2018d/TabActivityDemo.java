...
public class TabActivityDemo extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tab_activity_demo, menu);
        return true;
    }
...
//            View rootView = inflater.inflate(R.layout.fragment_tab_activity_demo, container, false);
